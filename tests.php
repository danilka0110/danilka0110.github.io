                ...
                <div class="row text-center">
                    ...
                    <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                        <div class="card" style="border: 1px solid black">
                            <div class="card-body">
                                <h5 class="card-title"><a href="pages/test.php?id=<?php echo $row['id']; ?>">
                                        <?php echo $row['title']; ?>
                                    </a></h5>
                                <p class="card-text">Здесь находиться описание текста</p>
                                <a href="pages/test.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Пройти тест</a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
